...
describe("error handling", () => {
  ...
  it("returns Err for an unknown transaction reference", async () => {
    const sdk = createTestSdk();
  ...
  it("returns Err when collectPayment amount is below the minimum", async () => {
    const sdk = createTestSdk();
  ...
  it.skipIf(!isLiveMode)(
    "returns an auth error for a revoked API key (live only)",
    async () => {
